 ...
 * @param file - manifest path or tarball member to normalize.
 * @returns The path a manifest and a tarball name identically.
 */
export function payloadPath(file: string): string {
