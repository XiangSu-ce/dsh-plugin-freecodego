...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    unchanged code or spans tasks), report it as an UNVERIFIABLE item instead of
    ...
    **Structure:**
    ...
    - PASS (spec compliant) | FAIL (issues found): [what's missing/extra/
      misunderstood, with file:line references]
    - UNVERIFIABLE (cannot verify from diff): [requirements you could not verify
      from the diff alone, and what the controller should check — report alongside
      the PASS/FAIL verdict for everything you could verify]
...
**Reviewer returns:** Spec Compliance verdict (PASS/FAIL/UNVERIFIABLE), Strengths,
